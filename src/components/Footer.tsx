      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-2xl font-bold">Hailey</h3>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              임신한 아내를 위한 맞춤형 서비스로, 건강한 임신과 출산을 함께 준비합니다.
              전문적인 정보와 개인화된 관리 도구를 제공합니다.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>이메일: support@hailey.com</li>
              <li>전화: 02-1234-5678</li>
              <li>운영시간: 평일 9AM-6PM</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Hailey. 모든 권리 보유. 임신한 아내를 위한 특별한 서비스
          </p>
          <div className="mt-4 space-x-4 text-sm text-gray-500">
            <button className="hover:text-gray-300 transition-colors">개인정보처리방침</button>
            <button className="hover:text-gray-300 transition-colors">이용약관</button>
            <button className="hover:text-gray-300 transition-colors">고객지원</button>
          </div>
        </div>
      </div>
    </footer>
